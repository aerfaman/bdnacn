                    ...
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                <li class="new">
                                    <a href="">
                                        <span class="thumb"><img src="{{ URL::asset('/') }}images/photos/user1.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="{{ URL::asset('/') }}images/photos/user2.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="{{ URL::asset('/') }}images/photos/user3.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="{{ URL::asset('/') }}images/photos/user4.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="{{ URL::asset('/') }}images/photos/user5.png" alt="" /></span>
                                        <span class="desc">
                            ...
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ URL::asset('/') }}images/photos/user1.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ URL::asset('/') }}images/photos/user2.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ URL::asset('/') }}images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ URL::asset('/') }}images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ URL::asset('/') }}images/photos/user5.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">Hoffman Doe</a> - Support
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="{{ URL::asset('/') }}images/photos/user2.png" alt=""/>
                                </a>
                                <div class="media-body">
...
<script src="http://cdnjs.cloudflare.com/ajax/libs/underscore.{{ URL::asset('/') }}js/1.5.2/underscore-min.js"></script>
