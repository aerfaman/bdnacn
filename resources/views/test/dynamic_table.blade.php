...
<head>
  ...
  <!--dynamic table-->
  <link href="{{ URL::asset('/') }}js/advanced-datatable/{{ URL::asset('/') }}css/demo_page.css" rel="stylesheet" />
  <link href="{{ URL::asset('/') }}js/advanced-datatable/{{ URL::asset('/') }}css/demo_table.css" rel="stylesheet" />
...
<!--dynamic table-->
<script type="text/javascript" language="javascript" src="{{ URL::asset('/') }}js/advanced-datatable/{{ URL::asset('/') }}js/jquery.dataTables.js"></script>
